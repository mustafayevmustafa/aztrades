        ...
        @forelse($sacs as $index => $sac)
            <div class="col-12">
                ...
                <div class="row d-flex align-items-center m-0">
                    ...
                    <x-forms.input        name="sacs[{{$index}}][name]" :value="$sac['name']" />
                    <x-forms.input        name="sacs[{{$index}}][sac_count]"  :value="$sac['sac_count']" />
                    <x-forms.input        name="sacs[{{$index}}][sac_weight]"  :value="$sac['sac_weight']" />
                    @if($action)
