...
<div class="header">
  ...
  <div class="header-right-panel">
    <div class="header-right-panel-top">
      ...
      <p> <a href="#">Mail Us : info@websitename.com</a>
    </div>
    <div class="menu">
      <ul>
        <li class="marRight20"><a href="index.blade.php">home</a></li>
        <li class="marRight20"><a href="about.blade.php">about</a></li>
        <li><a href="services.blade.php" class="active">services</a></li>
        <li class="marRight20"><a href="features.blade.php">features</a></li>
        <li class="marRight20"><a href="#">blog</a></li>
    ...
    <div class="primary-content marRight30">
      <div class="mid-panel">
        <div class="panel">
          ...
          <div class="content marginTop"> <img src="images/img-4.jpg" width="200" height="200" class="marRight30"/>
          ...
          <div class="content marginTop"> <img src="images/img-5.jpg" width="200" height="200" class="marRight30"/>
          ...
          <div class="clearing"></div>
          <div class="content marginTop"> <img src="images/img-6.jpg" width="200" height="200" class="marRight30"/>
          ...
          <div class="clearing"></div>
          <div class="content marginTop"> <img src="images/img-5.jpg" width="200" height="200" class="marRight30"/>
            <h2>Aliquam tincidunt mauris.</h2>
            <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate sem tristique cursus. Nam nulla quam, gravida non, commodo a, sodales sit amet, nisi.</p>
            <p>Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus.</p>
          </div>
          <div class="clearing"></div>
        ...
        <div class="content">
          ...
          <div class="container">
            <div class="left marRigth20">
              <h2>Amenda</h2>
              <p>Imperdiet nisl ut congue purus adipiscing eget

                magna donec tristuque.</p>
            </div>
            <div class="img"><img src="images/img-7.jpg"
...
/></div>
          ...
          <div class="container">
            ...
            <div class="img"><img src="images/img-8.jpg" /></div>
          </div>
          <div class="container borderNone">
            ...
            <div class="img"><img src="images/img-9.jpg" /></div>
          </div>
        </div>
      </div>
    </div>
