                    ...
                    <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if(
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.01" step=".1" value="{{ $data->getAttribute('weight') }}" name="weight" class="form-control" id="post-title" placeholder="Çəki (kq)">
                                @error('weight')
                                <p class="text-danger">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0.01" step=".1" value="{{ $data->getAttribute('price') }}" name="price" class="form-control" id="post-title" placeholder="Qiymət">
                            @error('price')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
